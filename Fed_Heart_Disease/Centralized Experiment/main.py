...
avg_test_loss, std_test_loss, avg_test_roc_auc, std_roc_auc, \
    avg_test_acc,std_test_acc, avg_cpu_time, std_cpu_time, avg_elapsed_time, \
    std_elapsed_time, avg_ram_usage, std_ram_usage = run_experiments(
