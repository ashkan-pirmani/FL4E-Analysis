...
center_pooled_train = torch.utils.data.ConcatDataset(
    (train_datasets[0], train_datasets[1], train_datasets[2], train_datasets[3], train_datasets[4], train_datasets[5]))
center_pooled_test = torch.utils.data.ConcatDataset(
    (test_datasets[0], test_datasets[1], test_datasets[2], test_datasets[3], test_datasets[4], test_datasets[5]))
