...
import torch
import flwr as fl
from utils import Baseline, load_partition
...
class FL4EClients(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        print(
            f" C-index: {result['val_c_index']}|| Train Loss: {result['train_loss']:.4f}")
        print(
    ...
    def evaluate(self, parameters, config):
        ...
        test_loss, test_c_index = utils.test(model=model, test_dataset=testset, batch_size=batch_size)
